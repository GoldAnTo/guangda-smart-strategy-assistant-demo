...
console.log('发送归因分析请求...')
const body = JSON.stringify({ model: 'gpt-5.4', input: longPrompt, max_tokens: 1500 })
const options = {
  hostname: 'zxcode.vip',
  port: 443,
  path: '/v1/responses',
...
const req = https.request(options, (res) => {
  ...
  res.on('end', () => {
    ...
    console.log('output:', JSON.stringify(json.output, null, 2).slice(0, 2000))
  })
})
